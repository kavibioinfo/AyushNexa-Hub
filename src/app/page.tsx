...
const VivahBanner = () => (
  ...
  >
    ...
    <circle cx="30" cy="55" r="18" fill="#FCEBD8" />
    <circle cx="30" cy="55" r="11" fill="#F5C9A0" />
    <circle cx="30" cy="55" r="5" fill="#E8A020" />
    <circle cx="310" cy="55" r="18" fill="#FCEBD8" />
    <circle cx="310" cy="55" r="11" fill="#F5C9A0" />
    <circle cx="310" cy="55" r="5" fill="#E8A020" />
    <line
      x1="30"
      y1="37"
      x2="30"
    ...
    <circle cx="145" cy="90" r="2.5" fill="#C0392B" />
    <circle cx="155" cy="88" r="2" fill="#E8A020" />
    <circle cx="163" cy="87" r="1.5" fill="#C0392B" />
    <circle cx="170" cy="87" r="2.5" fill="#8B1A1A" />
    <circle cx="177" cy="87" r="1.5" fill="#C0392B" />
    <circle cx="185" cy="88" r="2" fill="#E8A020" />
...
const ResumeBanner = () => (
  ...
  >
    ...
    <text x="184" y="28" textAnchor="middle" fontSize="6" fill="white" fontWeight="700">
      HIRED
    </text>
    <circle cx="78" cy="46" r="14" fill="#DBEAFE" stroke="#85B7EB" strokeWidth="0.5" />
    <text x="78" y="44" textAnchor="middle" fontSize="10" fill="#185FA5">
      ✓
    </text>
    <text x="78" y="54" textAnchor="middle" fontSize="6" fill="#185FA5" fontWeight="600">
      Ready
    </text>
    <circle cx="255" cy="52" r="13" fill="#DBEAFE" stroke="#85B7EB" strokeWidth="0.5" />
    <text x="255" y="49" textAnchor="middle" fontSize="7" fill="#185FA5" fontWeight="600">
      PDF
    </text>
    <text x="255" y="59" textAnchor="middle" fontSize="6" fill="#185FA5">
      Export
    </text>
  </svg>
);
...
const ExpenseBanner = () => (
  ...
  >
    ...
    <text x="170" y="64" textAnchor="middle" fontSize="9" fill="#633806" fontWeight="700">
      ₹
    </text>
    <circle cx="192" cy="52" r="8" fill="#EF9F27" stroke="#BA7517" strokeWidth="1" />
    <text x="192" y="56" textAnchor="middle" fontSize="8" fill="#633806" fontWeight="700">
      ₹
    </text>
    <circle cx="210" cy="64" r="7" fill="#FAC775" stroke="#EF9F27" strokeWidth="0.8" />
    <text x="210" y="68" textAnchor="middle" fontSize="7" fill="#633806" fontWeight="700">
      ₹
    </text>
    ...
    <text x="69" y="62" textAnchor="middle" fontSize="7" fill="#27500A" fontWeight="600">
      Save
    </text>
  </svg>
);
...
const CareerBanner = () => (
  ...
  >
    ...
    <path
      d="M38 92 Q100 80 162 60 Q222 40 302 28"
      fill="none"
      stroke="#AFA9EC"
      strokeWidth="10"
      strokeLinecap="round"
    ...
    <text x="302" y="33" textAnchor="middle" fontSize="14" fill="#534AB7">
      ★
    </text>
  </svg>
);
...
const BmiBanner = () => (
  ...
  >
    ...
    <text x="99" y="69" textAnchor="middle" fontSize="8" fill="white" fontWeight="700">
      BMI
    </text>
    <rect
      x="52"
      ...
      strokeWidth="0.5"
    />
    <text x="69" y="37" textAnchor="middle" fontSize="8" fill="#085041" fontWeight="700">
      Free
    </text>
...
const EmiBanner = () => (
  ...
  >
    ...
    <rect
      ...
      strokeWidth="0.5"
    />
    <text x="68" y="37" textAnchor="middle" fontSize="8" fill="#633806" fontWeight="700">
      Free
    </text>
    ...
    <text x="285" y="62" textAnchor="middle" fontSize="9" fill="#633806" fontWeight="800">
      ₹
    </text>
    <text x="176" y="78" textAnchor="middle" fontSize="14" fill="#BA7517" fontWeight="700">
      =
    </text>
    <rect x="244" y="32" width="54" height="14" rx="7" fill="#FAEEDA" stroke="#EF9F27" strokeWidth="0.8" />
    <text x="271" y="42" textAnchor="middle" fontSize="7.5" fill="#633806" fontWeight="700">
      EMI / Month
    </text>
  </svg>
);
...
const BusinessKitBanner = () => (
  ...
  >
    ...
    <text x="85" y="51" textAnchor="middle" fontSize="8" fill="white" fontWeight="700">
      SHOP
    </text>
    ...
    <text x="170" y="34" textAnchor="middle" fontSize="7" fill="white" fontWeight="700">
      WhatsApp
    </text>
    <text x="170" y="44" textAnchor="middle" fontSize="7" fill="white">
      Campaign ✓
    </text>
    {/* Growth chart */}
    ...
    {/* Star reviews */}
    <text x="148" y="72" textAnchor="middle" fontSize="9" fill="#FBBF24">
      ★★★★★
    </text>
    <text x="148" y="82" textAnchor="middle" fontSize="6.5" fill="#1E3A8A" fontWeight="600">
      Google Reviews
    </text>
    {/* Rupee badge */}
    <rect x="285" y="18" width="40" height="16" rx="8" fill="#DBEAFE" stroke="#2563EB" strokeWidth="0.8" />
    <text x="305" y="29" textAnchor="middle" fontSize="8" fill="#1E40AF" fontWeight="700">
      ₹199
    </text>
  </svg>
);
...
const MedicalKitBanner = () => (
  ...
  >
    ...
    <path
      d="M75 47 Q75 32 90 28 Q105 24 105 38"
      fill="none"
      stroke="#059669"
      strokeWidth="2"
      strokeLinecap="round"
    ...
    <text x="170" y="46" textAnchor="middle" fontSize="8" fill="white" fontWeight="700">
      CLINIC / OPD
    </text>
    ...
    <text x="256" y="38" textAnchor="middle" fontSize="7" fill="white" fontWeight="700">
      Patient Chart
    </text>
    ...
    <text x="67" y="35" textAnchor="middle" fontSize="8" fill="#065F46" fontWeight="700">
      ₹399
    </text>
  </svg>
);
...
export default function Home() {
  ...
  const personalTools = [
    {
      ...
      description:
        "मराठी विवाह बायोडाटा तयार करा — फोटो, कुंडली व कौटुंबिक माहितीसह सुंदर पत्रिका मिनिटांत तयार होते.",
    ...
    },
    {
      ...
      description:
        "Create a modern, clean corporate resume with your profile photo instantly. Ready for regional, national and multi-national placement interviews.",
    ...
    },
    {
      ...
      description:
        "Track your daily expenses and manage savings. Unlock full asset balance sheet analytics for deep financial control.",
    ...
    },
    {
      ...
      description:
        "Discover high-growth career roadmaps built for Maharashtra students based on educational budget limits and psychometric aptitude core analysis.",
    ...
    },
    {
      ...
      description:
        "Check your precise body mass index score and unlock safe, verified household wellness care frameworks in one simple click.",
    ...
    },
    {
      ...
      description:
        "Simulate Home, Car, or Personal Loan EMIs with granular monthly interest breakup layouts and interactive real-time data tracking charts.",
      category: "Financial Analytics",
      slug: "emi-calculator",
      tag: "100% Free",
  ...
  const businessKits = [
    {
      ...
      headline:
        "Never struggle with social media content or client retention again.",
      description:
        "100+ AI Prompts, WhatsApp Campaigns, Google Review Systems & Marketing Templates engineered to multiply retail sales.",
      valueStack: [
    ...
    },
    {
      ...
      headline:
        "Eliminate administrative scheduling hurdles and attract quality patients.",
      description:
        "Engineered specifically for Clinics, Dentists, and Practitioners. Contains automated booking reminders, treatment prompts, and review systems.",
      valueStack: [
  ...
  return (
    <div className="min-h-screen bg-white text-[#0F172A] font-sans antialiased">
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <Link
                href="/"
                className="text-md sm:text-lg font-black tracking-tight text-[#0F172A]"
              >
                AyushNexa <span className="text-[#2563EB]">Hub</span>
              </Link>
            </div>
            <span className="hidden lg:inline-block text-[9px] sm:text-[10px] font-bold text-[#64748B] bg-[#F1F5F9] border border-[#E2E8F0] px-2 py-0.5 rounded uppercase tracking-wider">
          ...
          <div className="hidden md:flex items-center gap-6 text-xs sm:text-sm font-bold uppercase tracking-wide text-[#64748B]">
            <a href="#explore" className="hover:text-[#2563EB] transition-colors">
              Tools
            </a>
            <a href="#explore" className="hover:text-[#2563EB] transition-colors">
              Growth Kits
            </a>
            <a href="#stats" className="hover:text-[#2563EB] transition-colors">
              Statistics
            </a>
            <a href="#founder" className="hover:text-[#2563EB] transition-colors">
              Credibility
            </a>
          </div>
          <a
            href="#explore"
            className="inline-flex h-9 items-center justify-center rounded-lg bg-[#0F172A] px-4 text-xs font-bold text-white shadow-sm hover:bg-[#2563EB] transition-colors"
          >
            Get Started
          </a>
        </div>
      ...
      {/* ── HERO ── */}
      <header className="relative bg-gradient-to-b from-[#F8FAFC] to-white pt-20 pb-12 sm:pt-24 sm:pb-16 overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl sm:text-7xl font-black tracking-tight text-[#0F172A] leading-[1.1] sm:leading-[1.05]">
            Grow Faster.
            <br />
            <span className="bg-gradient-to-r from-[#2563EB] to-[#0F172A] bg-clip-text text-transparent">
              Work Smarter.
            </span>
          </h1>
          <p className="mt-5 sm:mt-6 text-base sm:text-lg text-[#64748B] max-w-2xl mx-auto font-medium leading-relaxed">
            Free AI Tools, Career Resources, Business Growth Kits and Digital
            Systems built for students, professionals and local businesses across
            Maharashtra.
          </p>
        </div>
      </header>
      ...
      {/* ── PRODUCTS ── */}
      <section id="explore" className="py-12 sm:py-16 bg-white">
          ...
          <div className="flex justify-center mb-10 sm:mb-12">
            <div className="inline-flex rounded-xl bg-[#F1F5F9] p-1 border border-[#E2E8F0]">
              <button
                ...
                className={`rounded-lg px-4 sm:px-6 py-2 text-[11px] sm:text-xs font-black tracking-wide uppercase transition-all ${
                  activeTab === "personal"
            ...
            <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 max-w-4xl mx-auto">
              {personalTools.map((tool, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className={`relative overflow-hidden rounded-2xl border-2 ${tool.borderColor} hover:shadow-xl transition-all bg-white flex flex-col group`}
                  >
                    ...
                    <div className="p-5 flex flex-col flex-1">
                      <div className="flex justify-between items-start mb-2 gap-2 flex-wrap">
                        <span
                          className={`text-[10px] sm:text-[11px] font-black uppercase tracking-wider ${tool.catColor}`}
                        >
                          {tool.category}
                        </span>
                        <span
                          className={`text-[10px] sm:text-[11px] font-black px-2.5 py-0.5 rounded border whitespace-nowrap ${tool.tagStyle}`}
                        >
                          {tool.tag}
                        </span>
                      </div>
                      {tool.isVivah ? (
                        <>
                          ...
                          <p className="text-[11px] sm:text-xs font-semibold text-[#C0392B] mb-1">
                            {tool.title}
                          </p>
                        </>
                      ) : (
                        <h3 className="text-base sm:text-lg font-black text-[#0F172A] mb-1">
                          {tool.title}
                        </h3>
                      )}
                      <p className="text-sm sm:text-xs text-[#475569] leading-relaxed flex-1">
                        {tool.description}
                      </p>
                      <div className={`mt-5 pt-4 border-t ${tool.dividerColor}`}>
                        <Link
                          href={`/tools/${tool.slug}`}
                          className={`text-sm sm:text-xs font-black uppercase tracking-wide flex items-center gap-1 ${tool.ctaColor}`}
                        >
                          {tool.cta}
                        </Link>
                      </div>
            ...
            <div className="grid gap-8 max-w-4xl mx-auto">
              {businessKits.map((kit, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="bg-white border border-[#E2E8F0] rounded-2xl overflow-hidden hover:shadow-xl transition-all group"
                    ...
                    <div className="p-5 sm:p-8 flex flex-col md:flex-row gap-6">
                      ...
                      <div className="flex-1 space-y-4">
                        <div className="flex flex-wrap items-center gap-2">
                          <span
                            className="text-[9px] sm:text-[10px] font-black px-2.5 py-0.5 rounded-full border"
                            style={{
                              background: kit.accentLight,
                              color: kit.accentColor,
                              borderColor: kit.accentColor + "30",
                            }}
                          >
                            {kit.badge}
                          </span>
                          <span className="text-[10px] sm:text-[11px] text-[#64748B] font-bold">
                            • {kit.targetAudience}
                          </span>
                        </div>
                        <div>
                          <h3 className="text-base sm:text-xl font-black text-[#0F172A] tracking-tight leading-tight">
                            {kit.title}
                          </h3>
                          <p
                          ...
                          <p className="text-sm sm:text-xs text-[#475569] mt-1.5 font-medium leading-relaxed">
                            {kit.description}
                          </p>
                        </div>
                        <div className="bg-[#F8FAFC] rounded-xl border border-[#E2E8F0] p-4">
                          <span className="text-[10px] sm:text-[11px] font-black text-[#0F172A] uppercase tracking-wider block border-b border-gray-200 pb-1.5 mb-2">
                            🎁 What&apos;s Included:
                          </span>
                          <div className="grid gap-1.5 grid-cols-1 sm:grid-cols-2 text-xs sm:text-[11px] text-[#475569] font-semibold">
                            {kit.valueStack.map((item, i) => (
                              <div key={i} className="flex items-center gap-1">
                                <span style={{ color: kit.accentColor }}>✓</span>{" "}
                                {item}
                              </div>
                            ))}
                          </div>
                      ...
                      {/* Right price box */}
                      <div
                        className="w-full md:w-52 rounded-2xl border p-5 text-center flex flex-col justify-center shrink-0"
                        style={{
                          background: kit.accentLight,
                          borderColor: kit.accentColor + "25",
                        }}
                      >
                        <span className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest block text-[#64748B]">
                        ...
                        <span className="text-xs text-[#94A3B8] line-through mt-0.5">
                          {kit.originalPrice}
                        </span>
                        <div
                          className="mt-1 text-[8px] sm:text-[9px] font-black uppercase px-3 py-0.5 rounded-full inline-block mx-auto"
                          style={{
                            background: kit.accentColor + "15",
                            color: kit.accentColor,
                          }}
                        >
                          Massive Savings
                        ...
                        <p className="text-[8px] sm:text-[9px] text-[#94A3B8] mt-2">
      ...
      {/* ── STATS ── */}
      <section id="stats" className="py-10 sm:py-12 bg-white border-y border-[#E2E8F0]">
        <div className="max-w-4xl mx-auto px-4">
          <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div
                key={i}
                className="p-4 sm:p-5 text-center rounded-2xl bg-[#F8FAFC] border border-[#E2E8F0]"
              >
                <h3 className="text-2xl sm:text-3xl font-black tracking-tight" style={{ color: col }}>
                  {num}
                </h3>
                <p className="text-[9px] sm:text-[10px] font-black text-[#64748B] uppercase tracking-widest mt-1">
                  {label}
                </p>
              </div>
            ))}
      ...
      {/* ── TRUST BAR ── */}
      <section className="px-4 max-w-4xl mx-auto my-10 sm:my-12">
        <div className="grid gap-2 grid-cols-2 sm:grid-cols-5 bg-[#F8FAFC] border border-[#E2E8F0] p-4 sm:p-5 rounded-2xl text-center">
          {[
            ...
            >
              ...
              <span className="text-[9px] sm:text-[10px] font-black text-[#0F172A] uppercase tracking-wider mt-1.5">
                {label}
              </span>
            </div>
          ))}
      ...
      <section
        id="founder"
        className="py-12 sm:py-16 bg-[#F8FAFC] border-t border-[#E2E8F0]"
      >
        <div className="max-w-4xl mx-auto px-6 flex flex-col md:flex-row items-center gap-6 sm:gap-8">
          ...
          <div className="text-center md:text-left">
            <span className="text-[9px] sm:text-[10px] font-black text-[#2563EB] uppercase tracking-widest block">
              Brand Credibility Node
            </span>
            <h3 className="text-lg sm:text-xl font-black text-[#0F172A] tracking-tight mt-0.5">
              Built by AyushNexa Digital Solutions
            </h3>
            <p className="text-sm sm:text-xs text-[#475569] mt-2 leading-relaxed font-medium">
              We are engineered specifically to help regional entrepreneurs, local
              businesses, doctors, clinics, gyms, salons, and coaching institutes
              streamline their tech stack. AyushNexa provides secure cloud
              utilities that maximize local visibility seamlessly across
              Maharashtra.
            </p>
          </div>
        </div>
      ...
      {/* ── FOOTER ── */}
      <footer className="bg-white border-t border-[#E2E8F0] py-8 sm:py-10 text-center text-[11px] sm:text-xs text-[#64748B]">
        <div className="max-w-4xl mx-auto px-6 space-y-3">
          <div className="flex justify-center items-center gap-1 font-bold text-[#0F172A] flex-wrap">
            <span>🛡️</span>
            <span>100% Secure SSL Payment Routing by Razorpay Network</span>
          </div>
          <p className="text-[10px] sm:text-[11px] text-gray-400 max-w-sm mx-auto">
            Encrypted lifetime access keys distributed directly upon successful
            authentication routing.
          </p>
          <div className="pt-5 sm:pt-6 border-t border-gray-100 flex flex-col sm:flex-row justify-between items-center text-[9px] sm:text-[10px] text-gray-400 gap-2">
