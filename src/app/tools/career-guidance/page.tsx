...
export default function CareerGuidance() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A] pb-12">
        ...
        {step === 3 && (
          <div className="space-y-8">
            <div className="bg-white border p-6 rounded-2xl shadow-sm flex justify-between items-center flex-wrap gap-4">
              ...
              <button onClick={() => window.print()} className="h-9 px-4 rounded-lg bg-[#10B981] text-white text-xs font-bold print:hidden">📥 Print Summary</button>
            </div>
              ...
              <div className="bg-white border rounded-2xl p-6 shadow-md space-y-5 h-fit">
                ...
                {!isPremiumUnlocked ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <button onClick={() => window.print()} className="w-full h-11 bg-[#10B981] text-white font-bold text-sm rounded-xl shadow-md flex items-center justify-center gap-2"><Download className="w-4 h-4" />📑 Download 15-Page SWOT Report (Print/Save as PDF)</button>
                  </div>
                )}
              </div>
            </div>
      ...
      {/* ========== PRINTABLE REPORT (always present, hidden on screen) ========== */}
